...
struct KeyCodes {
    ...
    static func toString(_ keyCode: Int) -> String {
        return keyCodeMap[keyCode] ?? "Key\(keyCode)"
    }

    static func shortcutString(keyCode: Int, modifiers: Int) -> String {
        var result = ""
...
class ShortcutRecorderView: NSView {
    ...
    private func updateDisplay() {
        if isRecording {
            ...
            shortcutLabel.stringValue = KeyCodes.shortcutString(keyCode: keyCode, modifiers: modifierFlags)
